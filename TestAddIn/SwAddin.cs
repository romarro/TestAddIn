...
namespace TestAddIn
{
    ...
    /// </summary>
    [Guid("58066922-ca6d-4ea5-b7b9-11a412ea3693"), ComVisible(true)]
    [SwAddin(
        Description = "TestAddIn description",
        Title = "TestAddIn",
        LoadAtStartup = true
        )]
    public class SwAddin : ISwAddin
    {
        ...
        public void AddCommandMgr()
        {
            ...
            cmdGroup.LargeIconList = iBmp.CreateFileFromResourceBitmap("TestAddIn.ToolbarLarge.bmp", thisAssembly);
            cmdGroup.SmallIconList = iBmp.CreateFileFromResourceBitmap("TestAddIn.ToolbarSmall.bmp", thisAssembly);
            cmdGroup.LargeMainIcon = iBmp.CreateFileFromResourceBitmap("TestAddIn.MainIconLarge.bmp", thisAssembly);
            cmdGroup.SmallMainIcon = iBmp.CreateFileFromResourceBitmap("TestAddIn.MainIconSmall.bmp", thisAssembly);
